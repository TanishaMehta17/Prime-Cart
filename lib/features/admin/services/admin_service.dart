...
class AdminServices {
  void sellProduct({
    ...
    try {
      final cloudinary = CloudinaryPublic('dgicbdqom', 'kdahia7n');
...
//get all the products
  ...
  Future<List<Order>> fetchAllOrderss(BuildContext context) async {
    final userProvider = Provider.of<UserProvider>(context, listen: false);
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            ...
            Sales('Essentials', response['essentailEarnings']),
